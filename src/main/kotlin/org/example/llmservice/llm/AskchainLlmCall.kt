...
import org.example.llmservice.service.RecentWords
import org.example.llmservice.util.StringUtils
...
@Component
class AskchainLlmCall (
    private val chat: ChatClient,
    private val recentWords: RecentWords
){
    private val log = LoggerFactory.getLogger(AskchainLlmCall::class.java)
